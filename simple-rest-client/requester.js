...
function init() {
  ...
  $(".select").change(function() { toggleData(); });
  $(".select").focus(function() { toggleData(); });
}
...
console.log('1')
        ...
        //load();
        /*
         *  HOW TO GET THE JSON AS HTML
         *
         **/
        //var t =  jsonlint.parse('{"test":"true"}');
        //var s = JSON.stringify(t, null, "  ");
        //parsedObject = JSON.parse(s);
        //new JSONFormatter().jsonToHTML(parsedObject, 'bla');
         //new JSONFormatter().objectToHTML(parsedObject, 'bla');
