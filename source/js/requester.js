...
function sendAuthenticationHeader(){
	...
	try {
        ...
        a.href = $("#url").val();
        oAuthUrl = a.origin+'/oauth/authorize';
        var authorizeURL = oAuthUrl;
...
function sendRequestToken(requestToken,username,password){
	...
	try {
		var authorizeURL = oAuthUrl+'?request_token='+requestToken+'&username='+username+'&password='+password+'&ttl=7200';
		xhr.open('POST',authorizeURL, true);
